...
export default function Footer() {
  ...
  return (
    <>
      <footer className="relative z-30 border-t border-zinc-800 bg-black">
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-black-border bg-[#050505]">
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://github.com/PiyushY111" target="_blank" rel="noreferrer"><h3 className="font-display font-medium text-gold text-lg tracking-wide">GitHub</h3></a>
                </div>
                <button
                  onClick={() => setIsFileTreeOpen(false)}
